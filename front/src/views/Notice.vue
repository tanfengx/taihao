  ...
  <div>
    ...
    <div>
      ...
      <el-table-column label="创建人"><template #default="scope"><span v-if="scope.row.userId">{{ state.userOptions.find(v => v.id === scope.row.userId) ? state.userOptions.find(v => v.id === scope.row.userId).name : '' }}</span></template></el-table-column>
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-if="auths.includes('notice.edit')">修改</el-button>
    ...
    />
        ...
        <el-form-item prop="userId" label="创建人">
          <el-select clearable v-model="state.form.user_id" placeholder="请选择"  style="width: 100%">
