  ...
  <div>
    <div style="width: 80%; margin: 10px auto">
      <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;">
        <span style="font-size: 14px;margin-right: 20px;">首页 > 重置密码</span>
      </div>
      <el-form style="width: 50%; margin: 0 auto" label-width="110px" :model="state.form" :rules="rules" ref="ruleFormRef">
