...
<template>
  <div>
    ...
    <div>
      ...
      <el-table-column prop="index_radio" label="是否首页"></el-table-column>
      <el-table-column prop="url" label="链接地址"></el-table-column>

        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-if="auths.includes('banner.edit')">修改</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="轮播图信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        ...
        <el-form-item prop="indexRadio" label="是否首页">
