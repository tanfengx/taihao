...
// 导出接口
const exportData = () => {
  window.open(`http://${config.serverUrl}/paytype/export`)
}
...
<template>
  <div>
    ...
    <div>
      ...
      <el-upload
          v-if="auths.includes('paytype.import')"
          class="ml5"
          :show-file-list="false"
          style="display: inline-block; position: relative; top: 3px"
          :action='`http://${config.serverUrl}/paytype/import`'
      ...
      <el-button type="primary" @click="exportData" class="ml5" v-if="auths.includes('paytype.export')">
        <el-icon style="vertical-align: middle">
          <Top />
    ...
    <div>
      ...
      <el-table-column prop="name" label="支付名称"></el-table-column>
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-if="auths.includes('paytype.edit')">修改</el-button>
