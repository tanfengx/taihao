...
<template>
  <div>
    ...
    <div>
      ...
      <el-table-column prop="isvip" label="是否会员"></el-table-column>
        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button type="primary" size="small" @click="handleEdit(scope.row)" v-if="auths.includes('member.edit')">修改</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" title="用户信息" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        ...
        <el-form-item prop="isvip" label="是否会员">
          <el-radio-group v-model="state.form.isvip">
